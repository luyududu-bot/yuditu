...
export const places = [
  ...
  },
  {
    ...
    y: 31,
    tags: ["入口", "北区", "出入口"],
    relations: { nearby: ["north_cafe", "building_14"], connects: ["outside", "east"] },
    actions: ["view_detail", "add_to_route", "set_as_start"],
    constraints: { requiresRegionUnlocked: true },
    metadata: {
      description: "位于校园东北侧，连接北区礼堂与校外道路的出入口。",
      facilities: ["出入口"],
      representativeScore: 0.46,
      visitMinutes: 2,
    },
  },
  {
    ...
    y: 62,
    tags: ["入口", "东侧", "出入口"],
    relations: { nearby: ["building_6", "building_7"], connects: ["outside", "south"] },
    actions: ["view_detail", "add_to_route", "set_as_start"],
    constraints: { requiresRegionUnlocked: true },
    metadata: {
      description: "位于校园东侧，邻近雕塑教学楼与设计学院·建筑学院。",
      facilities: ["出入口"],
